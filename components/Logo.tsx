		...
		<svg fill="none" viewBox="0 0 325 325" {...props}>
			...
			<g mask="url(#a)">
				<path
					fill="currentColor"
					fillRule="evenodd"
					d="M162.5 308.797c-80.642 0-146.252-65.619-146.252-146.273S81.858 16.25 162.5 16.25c80.641 0 146.251 65.62 146.251 146.274S243.141 308.797 162.5 308.797ZM162.5 0C72.751 0 0 72.766 0 162.524c0 89.762 72.751 162.525 162.5 162.525S325 252.286 325 162.524C325 72.766 252.249 0 162.5 0Z"
					clipRule="evenodd"
				/>
			</g>
