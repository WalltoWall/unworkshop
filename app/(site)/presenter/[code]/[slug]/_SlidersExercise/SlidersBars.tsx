...
export const SlidersBars = ({
			...
			content.push(
                <div key={i} className="h-full w-full flex justify-between items-end gap-2">
                    <div 
                        ...
                        style={{
                            height: countToday == 0 ? "1rem" : `${countToday * 10}%`,
                        }}
                    ></div>
                    <div 
                        key={i}
                        className={"relative block w-full max-w-[4rem] bg-yellow-68"}
                        style={{
                            height: countTomorrow == 0 ? "1rem" : `${countTomorrow * 10}%`,
	...
	return (
		<div className="top-0 left-0 right-0 px-4 w-full flex justify-evenly items-end gap-4 lg:gap-8"
        style={{
